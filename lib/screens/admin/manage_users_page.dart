...
class _ManageUsersPageState extends State<ManageUsersPage> {
  ...
  List<Map<String, dynamic>> get filteredAndSortedUsers {
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              const PopupMenuItem(
                value: 'created_at',
                child: Text('ترتيب حسب تاريخ التسجيل'),
              ),
              const PopupMenuItem(
                value: 'name',
  ...
  Widget _buildQuickStats() {
    ...
    final verifiedUsers = users.where((u) => u['is_verified'] == 1).length;
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: _buildStatCard('مستخدمين', regularUsers, Colors.green),
            ),
            const SizedBox(width: 8),
        ...
        Row(
          children: [
            Expanded(
              child: _buildStatCard('موثقين', verifiedUsers, Colors.teal),
            ),
            const SizedBox(width: 8),
            Expanded(
