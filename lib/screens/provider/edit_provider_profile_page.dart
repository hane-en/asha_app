...
class _EditProviderProfilePageState extends State<EditProviderProfilePage> {
  ...
  Future<void> _submitProfileUpdate() async {
    ...
    try {
      ...
      if (providerId == null) {
        throw Exception('لم يتم العثور على معرف مزود الخدمة');
      }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'نبذة عن الخدمات المقدمة',
                        border: OutlineInputBorder(),
                        prefixIcon: Icon(Icons.description),
                        hintText: 'اكتب نبذة مختصرة عن الخدمات التي تقدمها...',
                      ),
                      maxLines: 4,
                    ),
                    const SizedBox(height: 16),
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'عنوان مزود الخدمة',
                        border: OutlineInputBorder(),
                        prefixIcon: Icon(Icons.location_on),
                        hintText: 'العنوان التفصيلي لمزود الخدمة',
                      ),
                      maxLines: 2,
                    ),
                    const SizedBox(height: 16),
