  ...
  Future<void> _submitService() async {
    ...
    if (_nameController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            '❌ يرجى ملء جميع الحقول الإجبارية (الاسم، الفئة، السعر، الصورة)',
          ),
    ...
    try {
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('${Config.apiBaseUrl}/provider/add_service.php'),
      );
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('✅ ${data['message'] ?? 'تم إضافة الخدمة بنجاح'}'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('❌ ${data['message'] ?? 'فشل في إضافة الخدمة'}'),
            backgroundColor: Colors.red,
          ),
        );
      }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(isLoading ? 'جاري الإرسال...' : 'إضافة الخدمة'),
