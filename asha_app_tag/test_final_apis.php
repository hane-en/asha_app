<?php
echo "<h1>اختبار نهائي لجميع APIs</h1>\n";
...
$apis = [
    ...
    'الدفعات المعلقة' => 'http://localhost/asha_app_tag/api/admin/get_pending_payments.php',
    'طلبات تحديث البيانات' => 'http://localhost/asha_app_tag/api/admin/get_profile_requests.php'
];
