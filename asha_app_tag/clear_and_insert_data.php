<?php
/**
 * مسح وإدخال البيانات الافتراضية
 * يمسح جميع البيانات أولاً ثم يدخل البيانات الجديدة
 */
...
try {
    ...
    $result['message'] = 'بدء عملية مسح وإدخال البيانات...';
    
    // =====================================================
    // الخطوة 1: مسح جميع البيانات (بترتيب عكسي للـ Foreign Keys)
    // =====================================================
    $result['steps']['step0_clear'] = 'بدء مسح البيانات...';
    ...
    $database->query($clear_sql);
    $result['steps']['step0_clear'] = 'تم مسح جميع البيانات بنجاح';
    
    // =====================================================
    // الخطوة 2: إدخال الفئات
    // =====================================================
    ...
    // =====================================================
    // الخطوة 3: إدخال المستخدمين العاديين
    // =====================================================
    ...
    $result['success'] = true;
    $result['message'] = 'تم مسح وإدخال جميع البيانات بنجاح!';
    ...
    $result['message'] = 'فشل في مسح وإدخال البيانات: ' . $e->getMessage();
    $result['error'] = [
